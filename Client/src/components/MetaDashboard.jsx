...
const MetaDashboard = () => {
  ...
  const fetchDashboardData = async (accountId) => {
    ...
    try {
      ...
      const insRes = await fetch(`/api/meta/insights/${accountId}?preset=lifetime`, {
        headers
      });
      ...
      const accRes = await fetch(`/api/meta/accounts/${accountId}`, {
        headers
      });
      ...
      const leadsRes = await fetch('/api/meta/leads', {
        headers
      });
  ...
  const handleSyncRealtimeData = async () => {
    ...
    try {
      ...
      const accListRes = await fetch(`/api/meta/accounts?force=true`, {
        headers
      });
      ...
      const detailsRes = await fetch(`/api/meta/accounts/${accountId}?force=true`, {
        headers
      });
      ...
      const insRes = await fetch(`/api/meta/insights/${accountId}?preset=lifetime&force=true`, {
        headers
      });
      const insResult = await insRes.json();
              ...
              {[
                ...
                return (
                  <button
                    ...
                    className={`px-3 py-1.5 rounded-xl text-xs font-bold transition-all ${isActive
                        ...
                        return (
                          <React.Fragment key={page}>
                            ...
                            <button
                              ...
                              className={`w-7 h-7 flex items-center justify-center text-[11px] font-bold rounded-lg transition-all ${leadsCurrentPage === page
