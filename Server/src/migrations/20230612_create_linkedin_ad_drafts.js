...
module.exports = {
  async up(queryInterface, Sequelize) {
    await queryInterface.createTable('linkedin_ad_drafts', {
      ...
      campaign_id: { type: Sequelize.STRING(100), allowNull: true },
      creative_id: { type: Sequelize.STRING(100), allowNull: true },
      ad_name: { type: Sequelize.STRING(255), allowNull: true },
      ad_format: { type: Sequelize.STRING(50), allowNull: true },
